...
## Description
`iblir` is an R package containing a set of `learnr` tutorials that cover basic biostatistical concepts.
...
The main content of this package was developed by [Brian McKay](). The package is maintained by [Brian McKay]() and [Andreas Handel](https://www.andreashandel.com/). A full list of contributors and a Bibtex entry for the citation [can be found here](https://andreashandel.github.io/iblir/authors.html).
